...
leefDateFormat = "yyyy-MM-dd'T'HH:mm:ss.SSSSSS'Z'"
leefOmitFields = [
    "name", "critical"
]
leefCatagoriesByName = {
    "Network service modified": "breach",
    "Halo logout": "authentication",
    "Daemon compromised": "breach",
    "Authorized ips modified": "config",
    "Server group deleted": "config",
    "Configuration policy created": "config",
    "Alert profile created": "config",
    "Server access scan requested": "config",
    "Local account deleted (linux only)": "config",
    "Special events policy created": "config",
    "Daemon version changed": "alert",
    "Automatic server access scanning enabled": "system",
    "Alert profile modified": "config",
    "Daemon self-verification scheduled modfied": "alert",
    "File Integrity monitoring scan requested": "config",
    "Automatic software vulnerability management scan schedule modified": "alert",
    "Automatic configuration scanning disabled": "alert",
    "Special events policy deleted": "alert",
    "Halo backup codes generated": "config",
    "Configuration policy deleted": "alert",
    "Halo login failure": "authentication",
    "Automatic server access scan schedule modified": "alert",
    "Halo password recovery requested": "authentication",
    "Network service deleted": "alert",
    "File Integrity object signature changed": "alert",
    "File Integrity policy assigned": "alert",
    "Software vulnerability scan exception expired": "alert",
    "Software vulnerability detected": "alert",
    "Halo user account unlocked": "authentication",
    "Alert profile unassigned": "unknown",
    "Server missing": "alert",
    "Halo user account locked": "authentication",
    "Server shutdown": "alert",
    "Multiple root accounts detected (linux only)": "alert",
    "Automatic software vulnerability management scanning enabled": "config",
    "Local account activation requested": "authentication",
    "Local account created (linux only)": "alert",
    "Server un-retired": "config",
    "Automatic file integrity scan schedule modified": "alert",
    "Alert profile assigned": "config",
    "API Secret Key Viewed": "alert",
    "API Key Viewed": "alert",
    "Local account modification requested": "alert",
    "Halo user deactivated": "authentication",
    "Halo user reactivated": "authentication",
    "Configuration scan requested": "config",
    "API Key Created": "authentication",
    "API Secret Key Created": "authentication",
    "Special events policy unassigned": "alert",
    "Software vulnerability scan exception created": "alert",
    "File Integrity object missing": "alert",
    "File Integrity baseline expired": "alert",
    "Daily status email scheduled modified": "config",
    "Ghostports session close": "authentication",
    "Halo password recovery failed": "authentication",
    "Halo password recovery success": "authentication",
    "Halo password changed": "authentication",
    "API Key Modified": "alert",
    "API Secret Key Modified": "alert",
    "Automatic file integrity scanning enabled": "config",
    "Server firewall modified locally": "alert",
    "Configuration policy exported": "config",
    "Halo firewall policy assigned": "config",
    "Daemon self-verification scan requested": "config",
    "Configuration policy assigned": "config",
    "Halo firewall policy deleted": "alert",
    "Halo user modified": "alert",
    "Configuration rule matched": "alert",
    "File Integrity policy deleted": "alert",
    "Configuration policy imported": "config",
    "Software vulnerability scan requested": "config",
    "File Integrity policy created": "config",
    "Network service added": "alert",
    "File Integrity baseline failed": "alert",
    "Daemon heartbeat interval modified": "alert",
    "Automatic file integrity scanning disabled": "alert",
    "File Integrity policy unassigned": "config",
    "Server retired": "config",
    "File Integrity policy imported": "config",
    "Alert profile deleted": "alert",
    "File Integrity policy modified": "config",
    "Automatic software vulnerability management scanning disabled": "alert",
    "Automatic configuration scanning enabled": "config",
    "File Integrity policy changed": "config",
    "Ghostports expiration time modified": "config",
    "Halo firewall policy unassigned": "config",
    "Password configuration settings modified": "alert",
    "File Integrity exception created": "config",
    "Ghostports login success": "authentication",
    "Halo login success": "authentication",
    "Server deleted": "alert",
    "New server": "config",
    "Local account deactivation requested": "authentication",
    "File Integrity baseline": "config",
    "Automatic configuration scan schedule modified": "config",
    "Halo password recovery request failed": "authentication",
    "Ghostports provisioning": "config",
    "Local account creation requested": "authentication",
    "Special events policy assigned": "config",
    "Master account linked": "authentication",
    "Server moved to another group": "config",
    "Server firewall restore requested": "alert",
    "Server restarted": "alert",
    "Halo firewall policy created": "config",
    "Daemon self-verification enabled": "config",
    "File Integrity exception deleted": "config",
    "Server group added": "config",
    "Halo user re-invited": "authentication",
    "Ghostports login failure": "authentication",
    "File Integrity object added": "config",
    "API Key Deleted": "config",
    "API Secret Key Deleted": "config",
    "File Integrity baseline deleted": "config",
    "Daemon registration key regenerated": "authentication",
    "File Integrity policy exported": "config",
    "Daemon self-verification disabled": "alert",
    "Local account ssh keys update requested": "authentication",
    "File Integrity exception expired": "config",
    "Server ip address changed": "config",
    "Halo session timeout": "authentication",
    "Configuration policy unassigned": "config",
    "Configuration policy modified": "config",
    "Special events policy modified": "config",
    "Automatic server access scanning disabled": "alert",
    "Halo firewall policy modified": "config",
    "File Integrity re-baseline": "config",
    "Halo user invited": "authentication"
}
...
def printUsage(progName):
    ...
    print >> sys.stderr, "--leefsyslog\t\tWrite LEEF (Q1 Radar) to a syslog server"
    print >> sys.stderr, "--leeffile=<filename>\tWrite LEEF (Q1 Radar) to file with given filename"
...
def convertToLeef(ev):
    ...
    str += "%s|" % eventID
    if ev['name'] in leefCatagoriesByName:
        str += "cat=%s\t" % leefCatagoriesByName[ev['name']]
    else:
        str += "cat=unknown\t"
    severity = 3 # same non-critical severity as CEF
    for key in ev:
        if key in leefFieldMapping:
            str += "%s=%s\t" % (leefFieldMapping[key], ev[key])
